...
public final class Checksum {
  ...
  /**
   * Calculates XOR checksum of given String. Resulting hex value is returned as
   * a String in two digit format, padded with a leading zero if necessary.
   *
  ...
  /**
   * Returns the index of checksum separator char in specified NMEA sentence. If
   * separator is not found, returns the String length.
   *
