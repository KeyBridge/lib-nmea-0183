...
class CURParser extends SentenceParser implements CURSentence {
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.BODSentence#getCurrentDirection()
   */
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.BODSentence#getCurrentDirectionReference()
   */
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.BODSentence#getCurrentHeadingReference()
   */
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.BODSentence#getCurrentSpeed()
   */
