...
import org.nmea.sentence.VWTSentence;
...
class VWTParser extends SentenceParser implements VWTSentence {
   ...
   */
  public VWTParser(TalkerType talker) {
    super(talker, SentenceType.VWT, 9);
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.VWTSentence#getWindAngle()
   */
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.VWTSentence#getDirectionLeftRight()
   */
  ...
  /*
   * (non-Javadoc) @see org.nmea.sentence.VWTSentence#getSpeedKmh()
   */
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.VWTSentence#getSpeedKnots()
   */
  ...
  /*
   * (non-Javadoc) @see org.nmea.sentence.VWTSentence#getSpeedMps()
   */
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.VWTSentence#setSpeedKmh(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.VWTSentence#setSpeedKnots(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.VWTSentence#setWindAngle(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * org.nmea.sentence.VWTSentence#setMode(org.nmea
