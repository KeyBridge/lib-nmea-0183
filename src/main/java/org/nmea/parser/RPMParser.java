...
class RPMParser extends SentenceParser implements RPMSentence {
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#getId()
   */
  @Override
  public int getId() {
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#getPitch()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#getRPM()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#getSource()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#isEngine()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#isShaft()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#setId(int)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#setPitch(double)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#setRPM()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#setSource(char)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.RPMSentence#setStatus(net.sf.marineapi
