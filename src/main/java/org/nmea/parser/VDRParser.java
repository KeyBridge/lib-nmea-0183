...
class VDRParser extends SentenceParser implements VDRSentence {
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.VDRSentence#getMagneticDirection()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.VDRSentence#getSpeed()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.VDRSentence#getTrueDirection()
   */
  @Override
   ...
   *
   * @see
   * org.nmea.sentence.VDRSentence#setMagneticDirection(double)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.VDRSentence#setSpeed(double)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.nmea.sentence.VDRSentence#setTrueDirection(double)
   */
  @Override
