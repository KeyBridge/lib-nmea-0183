 ...
 * implement {@link org.nmea.sentence.DateSentence}.
 *
...
public class Date {
   ...
   * Two-digit values lower than or equal to pivot are assigned to 21th century,
   * while greater values are assigned to 20th century.
   */
   ...
   * @param day   Day [1..31]
   * @throws IllegalArgumentException If any of the parameter is out of bounds.
   */
  ...
  /**
   * Get year. The date fields in NMEA 0183 may present year by using either two
   * or four digits. In case of only two digits, the century is determined by
   * comparing the value against {@link #PIVOT_YEAR}. Values lower than or equal
   * to pivot are added to 2000, while values greater than pivot are added to
   * 1900.
   *
  ...
  /**
   * Set year. The date fields in NMEA 0183 may present year by using either two
   * or four digits. In case of only two digits, the century is determined by
   * comparing the value against {@link #PIVOT_YEAR}. Values lower than or equal
   * to pivot are added to 2000, while values greater than pivot are added to
   * 1900.
