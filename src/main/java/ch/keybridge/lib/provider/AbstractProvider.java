...
import ch.keybridge.lib.provider.event.ProviderEvent;
import ch.keybridge.lib.provider.event.ProviderListener;
 ...
 * required sentences.
 * <p>
 * When constructing {@link ch.keybridge.lib.provider.event.PositionEvent}, the
...
public abstract class AbstractProvider<T extends ProviderEvent> implements
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.event.SentenceListener#readingPaused()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.event.SentenceListener#readingStarted()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.event.SentenceListener#readingStopped()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.event.SentenceListener#sentenceRead(
