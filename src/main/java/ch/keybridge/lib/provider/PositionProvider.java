 ...
 * @see ch.keybridge.lib.provider.event.PositionListener
 * @see ch.keybridge.lib.provider.event.PositionEvent
 * @see ch.keybridge.lib.nmea.io.SentenceReader
 */
public class PositionProvider extends AbstractProvider<PositionEvent> {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.provider.AbstractProvider#createProviderEvent()
   */
  @Override
