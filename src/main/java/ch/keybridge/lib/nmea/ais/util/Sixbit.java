 ...
 */
package ch.keybridge.lib.nmea.ais.util;

/**
 * AIS characters are encoded as 6 bit values concatenated into a bit array.
 * This class implements the higher level access to this bit array, storing and
 * retrieveing characters, integers, etc.
 *
 * @author Lázár József
 */
public class Sixbit {
...
//		fBitVector.dump();
   ...
   *
   * This function returns the content character as encoded in binary value. See
   * table 44 (page 100) of Rec. ITU-R M.1371-4.
   *
   * This function is used to convert binary data to ASCII. This is different
   * from the 6-bit ASCII to binary conversion for VDM messages; it is used for
   * strings within the datastream itself. eg. Ship Name, Callsign and
   * Destination.
   */
  ...
  /**
   * Returns the requested bits interpreted as an integer (MSB first) from the
   * message.
   *
