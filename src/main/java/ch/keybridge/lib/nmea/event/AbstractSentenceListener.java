 ...
 * {@link net.sf.marineapi.nmea.io.SentenceReader}.
 * <p>
...
public abstract class AbstractSentenceListener<T extends Sentence>
   ...
   * {@link ch.keybridge.lib.nmea.event.SentenceListener} interface.
   *
   * @see
   * net.sf.marineapi.nmea.event.SentenceListener#sentenceRead(net.sf.marineapi.nmea.event.SentenceEvent)
   */
