 ...
 */
package ch.keybridge.lib.nmea.event;
...
public interface SentenceListener extends EventListener {
  ...
  /**
   * Called after {@link net.sf.marineapi.nmea.io.SentenceReader} has timed out
   ...
   * {@link net.sf.marineapi.nmea.io.SentenceReader#DEFAULT_TIMEOUT}. This value
   * can be overridden with
   * {@link net.sf.marineapi.nmea.io.SentenceReader#setPauseTimeout(int)}.
   */
  void readingPaused();
