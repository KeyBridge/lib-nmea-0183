...
import ch.keybridge.lib.nmea.sentence.DBTSentence;
...
class DBTParser extends SentenceParser implements DBTSentence {
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.DBTSentence#getMeters()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.DBTSentence#getFathoms()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.DBTSentence#getFeet()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.DBTSentence#setMeters(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.DBTSentence#setFathoms(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.DBTSentence#setFeet(double)
   */
