...
class RTEParser extends SentenceParser implements RTESentence {
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RTESentence#getRouteId()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RTESentence#getSentenceCount()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RTESentence#getSentenceIndex()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RTESentence#getWaypointCount()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RTESentence#getWaypointIds()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RTESentence#isActiveRoute()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RTESentence#isFirst()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RTESentence#isLast()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RTESentence#isWorkingRoute()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RTESentence#setSentenceCount(int)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RTESentence#setSentenceIndex(int)
   */
