...
import ch.keybridge.lib.nmea.sentence.DTMSentence;
...
class DTMParser extends SentenceParser implements DTMSentence {
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.DTMSentence#setDatumSubCode(java.lang.
   * String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.DTMSentence#setLongitudeOffset(double)
   */
  @Override
