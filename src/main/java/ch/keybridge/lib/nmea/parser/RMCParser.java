...
class RMCParser extends PositionParser implements RMCSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMCSentence#getCorrectedCourse()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMCSentence#getCourse()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.DateSentence#getDate()
   */
  public Date getDate() {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMCSentence#getDirectionOfVariation()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMCSentence#getFaaMode()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMCSentence#getSpeed()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMCSentence#getDataStatus()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMCSentence#getVariation()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMCSentence#setCourse(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMCSentence#setSpeed(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMCSentence#setVariation(double)
   */
