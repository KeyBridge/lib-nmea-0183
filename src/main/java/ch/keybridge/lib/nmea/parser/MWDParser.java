...
import ch.keybridge.lib.nmea.sentence.MWDSentence;
...
class MWDParser extends SentenceParser implements MWDSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWDSentence#getMagneticWindDirection()
   */
  @Override
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWDSentence#getTrueWindDirection()
   */
  @Override
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWDSentence#getWindSpeed()
   */
  @Override
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWDSentence#getWindSpeedKnots()
   */
  @Override
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWDSentence#setMagneticWindDirections(double)
   */
  @Override
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWDSentence#setTrueWindDirection(double)
   */
  @Override
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWDSentence#setWindSpeed(double)
   */
  @Override
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWDSentence#setWindSpeedKnots(double)
   */
  @Override
