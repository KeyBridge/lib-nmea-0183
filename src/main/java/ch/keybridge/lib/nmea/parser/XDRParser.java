...
import ch.keybridge.lib.nmea.sentence.XDRSentence;
import ch.keybridge.lib.nmea.util.Measurement;
...
class XDRParser extends SentenceParser implements XDRSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.XDRSentence#addMeasurement(net.sf.marineapi.nmea.util.Measurement[])
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.XDRSentence#getMeasurements()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.XDRSentence#setMeasurement(net.sf.marineapi.nmea.util.Measurement)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.XDRSentence#setMeasurements(java.util.List)
   */
