...
import ch.keybridge.lib.nmea.sentence.APBSentence;
...
class APBParser extends SentenceParser implements APBSentence {
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.APBSentence#getDestionationWaypointId()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.APBSentence#getHeadingToDestionation()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.APBSentence#setCrossTrackError(double)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.APBSentence#setCycleLockStatus(net.sf.
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.APBSentence#setHeadingToDestinationTrue
   * (boolean)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.APBSentence#setStatus(net.sf.marineapi
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.APBSentence#setSteerTo(net.sf.marineapi
   * .nmea.util.Direction)
   */
  @Override
