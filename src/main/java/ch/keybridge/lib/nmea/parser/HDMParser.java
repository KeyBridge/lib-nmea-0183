...
import ch.keybridge.lib.nmea.sentence.HDMSentence;
...
class HDMParser extends SentenceParser implements HDMSentence {
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.HDMSentence#getHeading()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.HDMSentence#setHeading(double)
   */
