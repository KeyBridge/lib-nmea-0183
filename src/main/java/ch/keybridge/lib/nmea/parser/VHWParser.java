...
import ch.keybridge.lib.nmea.sentence.VHWSentence;
...
class VHWParser extends SentenceParser implements VHWSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.HeadingSentence#getHeading()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VHWSentence#getMagneticHeading()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VHWSentence#getSpeedKilometres()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VHWSentence#getSpeedKnots()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.HeadingSentence#isTrue()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.HeadingSentence#setHeading(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VHWSentence#setSpeedKmh(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VHWSentence#setSpeedKnots(double)
   */
