...
import ch.keybridge.lib.nmea.sentence.XTESentence;
...
class XTEParser extends SentenceParser implements XTESentence {
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.XTESentence#setCycleLockStatus(net.sf.
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.XTESentence#setStatus(net.sf.marineapi
   ...
   * (non-Javadoc)
   *
   * @see net.sf.marineapi.nmea.sentence.XTESentence#setSteerTo(net.sf.marineapi
   * .nmea.util.Direction)
   */
  @Override
