...
import ch.keybridge.lib.nmea.sentence.VWRSentence;
...
class VWRParser extends SentenceParser implements VWRSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWRSentence#getWindAngle()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWRSentence#getDirectionLeftRight()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.VWRSentence#getSpeedKmh()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWRSentence#getSpeedKnots()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.VWRSentence#getSpeedMps()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWRSentence#setSpeedKmh(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWRSentence#setSpeedKnots(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWRSentence#setWindAngle(double)
   */
