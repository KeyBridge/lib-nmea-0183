...
import ch.keybridge.lib.nmea.sentence.ZDASentence;
...
class ZDAParser extends SentenceParser implements ZDASentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.ZDASentence#getLocalZoneHours()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.ZDASentence#getLocalZoneMinutes()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.ZDASentence#setLocalZoneHours(int)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.ZDASentence#setLocalZoneMinutes()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.ZDASentence#toDate()
   */
