...
import ch.keybridge.lib.nmea.sentence.DPTSentence;
...
class DPTParser extends SentenceParser implements DPTSentence {
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.DepthSentence#getDepth()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.DPTSentence#getOffset()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.DepthSentence#setDepth(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.DPTSentence#setOffset(double)
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.DPTSentence#getMaximum()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.DPTSentence#setMaximum(int)
   */
