...
import ch.keybridge.lib.nmea.sentence.RMBSentence;
...
import ch.keybridge.lib.nmea.util.Direction;
...
class RMBParser extends PositionParser implements RMBSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMBSentence#getArrivalStatus()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMBSentence#getBearing()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMBSentence#getCrossTrackError()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMBSentence#getDestination()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMBSentence#getOriginId()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMBSentence#getRange()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMBSentence#getStatus()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMBSentence#getSteerTo()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMBSentence#getVelocity()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.RMBSentence#hasArrived()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMBSentence#setBearing(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMBSentence#setRange(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.RMBSentence#setVelocity(double)
   */
