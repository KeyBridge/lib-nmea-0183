...
class GGAParser extends PositionParser implements GGASentence {
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.GGASentence#getAltitude()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#getAltitudeUnits()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.GGASentence#getDgpsAge()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#getDgpsStationId()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#getFixQuality()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#getGeoidalHeight()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#getGeoidalHeightUnits()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#getHorizontalDOP()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.PositionSentence#getPosition()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#getSatelliteCount()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.TimeSentence#getTime()
   */
  public Time getTime() {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#setAltitude(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#setDgpsAge(int)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#setGeoidalHeight(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#setHorizontalDOP(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GGASentence#setSatelliteCount(int)
   */
  @Override
