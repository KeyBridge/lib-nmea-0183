...
import ch.keybridge.lib.nmea.sentence.HDTSentence;
...
class HDTParser extends SentenceParser implements HDTSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.parser.HeadingSentence#getHeading()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.parser.HeadingSentence#setHeading(double)
   */
