...
import ch.keybridge.lib.nmea.sentence.HDGSentence;
import ch.keybridge.lib.nmea.sentence.SentenceId;
import ch.keybridge.lib.nmea.sentence.TalkerId;
import ch.keybridge.lib.nmea.util.CompassPoint;
...
class HDGParser extends SentenceParser implements HDGSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.HDGSentence#getDeviation()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.HDGSentence#getHeading()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.HDGSentence#getVariation()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.HDGSentence#setDeviation(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.HDGSentence#setHeading(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.HDGSentence#setVariation(double)
   */
