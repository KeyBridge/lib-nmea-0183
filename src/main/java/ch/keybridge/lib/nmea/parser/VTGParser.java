...
class VTGParser extends SentenceParser implements VTGSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VTGSentence#getMagneticCourse()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.VTGSentence#getMode()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.VTGSentence#getSpeedKmh()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VTGSentence#getSpeedKnots()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VTGSentence#getTrueCourse()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VTGSentence#setMagneticCourse(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VTGSentence#setSpeedKmh(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VTGSentence#setSpeedKnots(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VTGSentence#setTrueCourse(double)
   */
