...
import ch.keybridge.lib.nmea.sentence.BODSentence;
 ...
 * @see ch.keybridge.lib.nmea.sentence.BODSentence
 */
class BODParser extends SentenceParser implements BODSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.BODSentence#getMagneticBearing()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.BODSentence#getOriginWaypointId()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.BODSentence#getTrueBearing()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.BODSentence#setTrueBearing(double)
   */
