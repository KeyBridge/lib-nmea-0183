...
import ch.keybridge.lib.nmea.sentence.VWTSentence;
...
class VWTParser extends SentenceParser implements VWTSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWTSentence#getWindAngle()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWTSentence#getDirectionLeftRight()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.VWTSentence#getSpeedKmh()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWTSentence#getSpeedKnots()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.VWTSentence#getSpeedMps()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWTSentence#setSpeedKmh(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWTSentence#setSpeedKnots(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.VWTSentence#setWindAngle(double)
   */
