...
import ch.keybridge.lib.nmea.util.GpsFixStatus;
...
class GSAParser extends SentenceParser implements GSASentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSASentence#getFixStatus()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSASentence#getHorizontalDOP()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.GSASentence#getMode()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSASentence#getPositionDOP()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSASentence#getSatelliteIds()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSASentence#getVerticalDOP()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSASentence#setPositionDOP(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSASentence#setVerticalDOP(double)
   */
