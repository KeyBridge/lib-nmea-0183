...
import ch.keybridge.lib.nmea.sentence.Checksum;
import ch.keybridge.lib.nmea.sentence.Sentence;
import ch.keybridge.lib.nmea.sentence.SentenceId;
import ch.keybridge.lib.nmea.sentence.SentenceValidator;
...
public class SentenceParser implements Sentence {
	 ...
	 * @throws ch.keybridge.lib.nmea.parser.DataNotAvailableException If the field is
	 *             empty
	 */
