...
public class SentenceParser implements Sentence {
   ...
   * @throws IllegalArgumentException If the specified sentence is invalid or if
  ...
  /**
   * Creates a new empty sentence with specified begin char, talker id, sentence
   * id and number of fields.
   *
  ...
  /**
   * Creates a new instance of SentenceParser. Parser may be constructed only if
  ...
  /**
   * Creates a new instance of SentenceParser with specified sentence data. Type
   * of the sentence is checked against the specified expected sentence type id.
   *
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.Sentence#getBeginChar()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.Sentence#getFieldCount()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.Sentence#getSentenceId()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.Sentence#getTalkerId()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.Sentence#isProprietary()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.Sentence#isValid()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.Sentence#reset()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.Sentence#setBeginChar(char)
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.Sentence#toSentence()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.Sentence#toSentence(int)
   */
   ...
   * @throws ch.keybridge.lib.nmea.parser.ParseException If field contains more
   *                                                     than one character
   */
  ...
  /**
   * Get contents of a data field as a String. Field indexing is zero-based. The
   * address field (e.g. <code>$GPGGA</code>) and checksum at the end are not
   * considered as a data fields and cannot therefore be fetched with this
   * method.
   * <p>
   ...
   * @throws ch.keybridge.lib.nmea.parser.DataNotAvailableException If the field
   *                                                                is empty
   */
  ...
  /**
   * Set double value in specified field, with given number of digits before and
   * after the decimal separator ('.'). When necessary, the value is padded with
   * leading zeros and/or rounded to meet the requested number of digits.
   *
   * @param index    Field index
   * @param value    Value to set
  ...
  /**
   * Sets the number of sentence data fields. Increases or decreases the fields
   * array, values in fields not affected by the change remain unchanged. Does
   * nothing if specified new size is equal to count returned by
   * {@link #getFieldCount()}.
   *
   ...
   * index. If parameter <code>first</code> is zero, all sentence fields are
   * replaced.
   * <p>
   * If the length of <code>newFields</code> does not fit in the sentence field
   ...
   * the sentence field count must not change, you may need to add empty Strings
   * to <code>newFields</code> in order to preserve the original number of
   * fields. Also, all existing values after <code>first</code> are lost.
   *
  ...
  /**
   * Returns all field values, starting from the specified index towards the end
   * of sentence.
   *
