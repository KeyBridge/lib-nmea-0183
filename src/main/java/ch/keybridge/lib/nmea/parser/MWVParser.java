...
class MWVParser extends SentenceParser implements MWVSentence {
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.MWVSentence#getAngle()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.MWVSentence#getSpeed()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWVSentence#getSpeedUnit()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.MWVSentence#getStatus()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.MWVSentence#isTrue()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWVSentence#setAngle(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWVSentence#setSpeed(double)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MWVSentence#setTrue(boolean)
   */
