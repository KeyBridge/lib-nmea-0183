...
class GSVParser extends SentenceParser implements GSVSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSVSentence#getSatelliteCount()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSVSentence#getSatelliteInfo()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSVSentence#getSentenceCount()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSVSentence#getSentenceIndex()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.GSVSentence#isFirst()
   */
  ...
  /*
   * (non-Javadoc) @see net.sf.marineapi.nmea.sentence.GSVSentence#isLast()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSVSentence#setSentenceCount(int)
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.GSVSentence#setSentenceIndex(int)
   */
