...
import ch.keybridge.lib.nmea.sentence.MTWSentence;
...
class MTWParser extends SentenceParser implements MTWSentence {
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MTWSentence#getTemperature()
   */
  ...
  /*
   * (non-Javadoc) @see
   * net.sf.marineapi.nmea.sentence.MTWSentence#setTemperature(double)
   */
