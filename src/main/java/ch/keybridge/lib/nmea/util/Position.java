...
public class Position {
  ...
  /**
   * Creates new instance of Position with latitude, longitude and datum. Notice
   * that altitude defaults to -0.0 and may be set later.
   *
   * @param lat   Latitude degrees
   * @param lon   Longitude degrees
   ...
   * radius</a> used in calculation is <code>6366.70702</code> km, based on the
   * assumption that 1 degrees is exactly 60 NM.
   *
  ...
  /**
   * Gets the position altitude from mean sea level. Notice that most sentences
   * with position don't provide this value. When missing, the default value in
   * <code>Position</code> is 0.0.
   *
