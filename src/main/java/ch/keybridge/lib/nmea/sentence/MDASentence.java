...
public interface MDASentence extends Sentence {
   ...
   *
   * @return Absolute humidity, percent, to the nearest 0,1 percent. NaN if not
   *         available.
   */
   ...
   *
   * @return Air temperature, degrees C, to the nearest 0,1 degree C. NaN if not
   *         available.
   */
   ...
   *
   * @return Wind direction, degrees True, to the nearest 0,1 degree. NaN if not
   *         available.
   */
   ...
   *
   * @return B = bar I = inches of mercury (inHg) P = pascal (1 bar = 100000 Pa
   *         = 29,53 inHg).
   */
   ...
   *
   * @return Relative humidity, percent, to the nearest 0,1 percent. NaN if not
   *         available.
   */
   ...
   *
   * @return B = bar I = inches of mercury (inHg) P = pascal (1 bar = 100000 Pa
   *         = 29,53 inHg). The secondary unit is almost always in bars.
   */
