...
public interface Sentence {
  ...
  /**
   * Get the sentence begin character. Although most of the sentences start with
   * '$', some of them use '!' as begin character.
   *
  ...
  /**
   * Get the sentence ID that specifies the sentence type and data it holds. ID
   * is the last three characters in address field. For example, in case of
  ...
  /**
   * Set the sentence begin character. Although most of the sentences start with
   * '$', some of them use '!' as begin character.
   *
   ...
   * done by {@link ch.keybridge.lib.nmea.sentence.SentenceValidator}, notice
   * that resulting sentence length is not checked. To also validate the length,
   * use {@link #toSentence(int)}.
   *
   * @see #toString()
   ...
   * @see #MAX_LENGTH
   * @return Sentence as String, equal to <code>toString()</code>.
   * @throws IllegalStateException If formatting results in invalid sentence or
   *                               specified maximum length is exceeded.
   */
  String toSentence(int maxLength);

  /**
   * Returns the String representation of the sentence, without line terminator
   * <code>CR/LR</code>. Checksum is calculated and appended at the end of the
