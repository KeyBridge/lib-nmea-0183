...
public class SentenceReader {
	...
	/**
	 * Adds a {@link ch.keybridge.lib.nmea.event.SentenceListener} that wants to receive all sentences read
	 * by the reader.
	 *
	 * @param listener {@link ch.keybridge.lib.nmea.event.SentenceListener} to be registered.
	 * @see ch.keybridge.lib.nmea.event.SentenceListener
	 */
	...
	/**
	 * Adds a {@link ch.keybridge.lib.nmea.event.SentenceListener} that is interested in receiving only
	 ...
	 *
	 * @param listener {@link ch.keybridge.lib.nmea.event.SentenceListener} to be removed.
	 */
